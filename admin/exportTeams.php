...
fputcsv($output, array('Here', 'Player', 'Team', 'Paid - Cash/Card/Check', 'ERVA - Cash/Card/Check'));
...
if ($result = mysqli_query($conn, 'SELECT 
	...
	while ($team = mysqli_fetch_array($result)) {
    	...
    	$player['entry_amount'] = ($team['entry_amount'] ? '$ '.number_format(($team['entry_amount']/100),2) : '');
        $player['erva'] = '';
